...
public class DDLIntegrationTest extends SQLIntegrationTestCase {
    ...
    public void test_add_column_all_supported_configs_applied_to_altered_table() throws Exception {
        ...
        execute("ALTER TABLE tbl ADD COLUMN col1 text " +
            // "generated always as 'test' " + TODO: add generated column once https://github.com/crate/crate/issues/12852 is fixed
            "not null " +
        ...
        assertThat((String) response.rows()[0][0], startsWith(
            """
                CREATE TABLE IF NOT EXISTS "doc"."tbl" (
                   ...
                   "col1" TEXT NOT NULL INDEX USING FULLTEXT WITH (
                      analyzer = 'simple'
                   ),
                   PRIMARY KEY ("id"),
