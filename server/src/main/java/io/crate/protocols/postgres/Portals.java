...
public class Portals {
    ...
    public Portal create(String portalName,
        ...
        if (preparedStmt.analyzedStatement() instanceof AnalyzedDeclareCursor) {
            return Cursor.declare(portalName, preparedStmt, params, analyzedStatement, resultFormatCodes);
        }
        if (preparedStmt.analyzedStatement() instanceof AnalyzedFetchFromCursor) {
            ...
            if (portal instanceof Cursor cursor) {
                cursor.bindFetch(preparedStmt, params, resultFormatCodes);
                return cursor;
            }
    ...
    public Portal getSafePortal(String portalName) {
    ...
    public void put(String portalName, Portal portal) {
        var oldPortal = portals.put(portalName, portal);
    ...
    public boolean containsKey(String cursorName) {
        return portals.containsKey(cursorName);
    }
